...
public class OAuthHandler {
  ...
  private static String createGroupWithAuthCode(String code) throws ApiException, UnsupportedEncodingException{
    ...
    System.out.println("Access Token: " + refreshedAccessTokenResponse.getAccessToken());
...
//    oAuthApi.revokeToken(token);
    ...
    return response + "<br>access token: " + refreshedAccessTokenResponse.getAccessToken();
  }
}
